                    ...
                    function obtenerListadoDeArchivos($directorio, $recursivo = false, $espacio = '', $url = '')
                    {
                        ...
                        while (($archivo = $dir->read()) !== false) {
                            ...
                            if (is_dir($directorio . $archivo)) {
                                ...
                                echo '<div class="col-sm-8" style="background-color: #DAE1EA;">' .
                                    '<p style="font-weight: bold;">' . $espacio . '<a href="' . $url . '/' . $archivo . '" target="_blank">' . $archivo . '</a> </p> ' .
                                    '</div>';
                                echo '<div class="col-sm-4 float-right" style="background-color: #DAE1EA;"><div class="float-right"><a href="' . $url . '/' . $archivo .
                                    '" class="btn btn-primary active" role="button" aria-pressed="true" download>Descargar</a>' .
                                    '</div></div>';
                      ...
                      $resultado = obtenerListadoDeArchivos("/var/www/html/descargas/archivos", true,  '', "https://amcmatis.quito.gob.ec/descargas/archivos" );
//                    $resultado = obtenerListadoDeArchivos("c:\Program Files (x86)\Zend\Apache2\htdocs\procesos-amc\descargas\archivos", true, '', "http://localhost/procesos-amc/descargas/archivos");
