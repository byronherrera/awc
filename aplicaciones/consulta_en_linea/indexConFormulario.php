...
<div class="container contact-form" id="consulta" style="display: none">
    ...
    no encontrar lo solitado llene el siguiente formulario, uno de nuestros funcionarios realizará la búsqueda en nuestro registros.</P>
    <form enctype="multipart/form-data" id="formulario" method="post">
        <div class="row">
            ...
            <div class="form-group">
                <label for="sitraformulario">DOCUMENTO SITRA.</label>
                <textarea class="form-control" id="sitraformulario" name="sitraformulario" required="required"
                          rows="3">Ingrese el número de Sitra </textarea>
            </div>
            <div class="form-group">
                <label for="expedienteformulario">NÚMERO EXPEDIENTE.</label>
                <textarea class="form-control" id="expedienteformulario" name="expedienteformulario" required="required"
                          rows="3">Ingrese el número de Expediente </textarea>
            </div>
