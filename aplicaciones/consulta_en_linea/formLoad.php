...
switch ($opcion) {
    ...
    case "ingresoConsulta":
        ...
        //$funcionarios = ["tanya.ortega@quito.gob.ec", "francisco.collaguazo@quito.gob.ec", "byron.herrera@quito.gob.ec" ];
...
function getmensajeSolicitudInformacionReceptada($nombre = '', $fecha = '')
{
    $texto = '<div style="font-family: Arial, Helvetica, sans-serif;">
                ...
                <p><br><br>
                 Estimado, ' . $nombre . ' hemos recibido su solicitud, un funcionario se encargará de recibir su pedido.<br>
