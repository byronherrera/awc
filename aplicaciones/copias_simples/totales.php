...
<head>
    ...
    <title>TOTALES SANCIONES LOCALES - EMERGENCIA</title>
...
<div class="container contact-form">
    ...
    <h3>TOTALES SANCIONES LOCALES - EMERGENCIA</h3>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-4"></div>
        <div class="col-sm-4 ">
            <a href="descargaTodoEmergenciaTotalesLocales.php">Descargar todo (xls)</a>
        </div>
        <div class="col-sm-4"></div>
    </div>
</div>
