...
switch ($opcion) {
    ...
    case "ingreso":
        ...
        $predioData = getUsuario($flujo['idpredioetapa1']);
        $predioDataSeguimiento = getUsuario($flujo['usurioscopiaetapa1']);
        $predioDataSeguimiento2 = getUsuario($flujo['usurioscopiaetapa2']);
        $predioDataFin = getUsuario($flujo['idprediofinal']);
        ...
        $data['etapa'] = 1;
        $contenidoMailAutorizacion1 = getmensajeEtapa($predioData['nombre'] . " - encargado de aprobacion de etapa 1", $data);

        $envioMail = enviarEmail($predioData['email'], $data['negocio'], $contenidoMailAutorizacion1, $predioDataSeguimiento['email'], $data, " Aprobación Etapa 1");
        //TODO validar en caso que email no se envie
        */
        break;
    case "aprobar":
        ...
        if ($etapa == 1) {
            if ($flujo['etapas'] == 2) {
                // 2 se envia email a la persona que realiza la aprobación de la solicitud
                $predioData = getUsuario($flujo['idpredioetapa2']);

                $retorno = setDataIdEtapa1($id, $accion, $motivo);
                $data['etapa'] = 2;
                $contenidoMailAutorizacion1 = getmensajeEtapa($predioData['nombre'] . " - encargado de aprobacion de etapa", $data);
                $envioMail = enviarEmail($predioData['email'], $data['negocio'], $contenidoMailAutorizacion1, $predioDataSeguimiento2['email'], $data, " Aprobación Etapa 2");
                ...
                $envioMail = enviarEmail($data['emailConcesionario'], $data['negocio'], $contenidoMailAutorizacion2, $predioDataFin['email'], $data, $estado);
    ...
    $texto = '<div style="font-family: Arial, Helvetica, sans-serif;">
                ...
                <table style="margin: 0 auto; border: 1px solid #1C6EA4; background-color: rgb(241,241,241);   text-align: left;border-collapse: collapse;">
                    <tr><td style="font-weight: bolder; font-family:Calibri Light; font-size: 1.2em; border: 1px solid #1C6EA4; background-color:  rgb(231,230,230); width: 35% ">Persona autorizada 1:</td>
                        <td style="font-family:Calibri Light; font-size: 1.2em;border: 1px solid #1C6EA4;">' . $data['nombre1'] . ', ' . $data['predio1'] . '</td></tr>
                    <tr><td style="font-weight: bolder; font-family:Calibri Light; font-size: 1.2em; border: 1px solid #1C6EA4; background-color: rgb(231,230,230); ">Persona autorizada 2:</td>
                        <td style="font-family:Calibri Light; font-size: 1.2em;border: 1px solid #1C6EA4;">' . $data['nombre2'] . ', ' . $data['predio2'] . '</td></tr>
                    <tr><td style="font-weight: bolder; font-family:Calibri Light; font-size: 1.2em; border: 1px solid #1C6EA4; background-color: rgb(231,230,230); ">Persona autorizada 3:</td>
                        <td style="font-family:Calibri Light; font-size: 1.2em;border: 1px solid #1C6EA4;">' . $data['nombre3'] . ', ' . $data['predio3'] . '</td></tr>
                    <tr><td style="font-weight: bolder; font-family:Calibri Light; font-size: 1.2em; border: 1px solid #1C6EA4; background-color: rgb(231,230,230); ">Persona autorizada 4:</td>
                        <td style="font-family:Calibri Light; font-size: 1.2em;border: 1px solid #1C6EA4;">' . $data['nombre4'] . ', ' . $data['predio4'] . '</td></tr>
                    <tr><td style="font-weight: bolder; font-family:Calibri Light; font-size: 1.2em; border: 1px solid #1C6EA4; background-color: rgb(231,230,230); ">Persona autorizada 5:</td>
                        <td style="font-family:Calibri Light; font-size: 1.2em;border: 1px solid #1C6EA4;">' . $data['nombre5'] . ', ' . $data['predio5'] . '</td></tr>
                    <tr><td style="font-weight: bolder; font-family:Calibri Light; font-size: 1.2em; border: 1px solid #1C6EA4; background-color: rgb(231,230,230); ">Persona autorizada 6:</td>
                        <td style="font-family:Calibri Light; font-size: 1.2em;border: 1px solid #1C6EA4;">' . $data['nombre6'] . ', ' . $data['predio6'] . '</td></tr>
                    </tbody>
                </table>
                </div>
                ';
