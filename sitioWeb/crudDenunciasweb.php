...
function select()
{
    ...
    $query = "SELECT * FROM amc_denuncias_web $where ORDER BY id DESC LIMIT $start, $limit";
    ...
    $query = "SELECT count(*) AS total FROM amc_denuncias_web $where";
    if ($databaseAMC->Query($query)
    ) {
...
function selectForm()
{
    ...
    $query = "SELECT *, (SELECT COUNT(*) FROM amc_denuncias_web b WHERE b.cedula= a.cedula) as totaldenuncias FROM amc_denuncias_web a WHERE a.id = $id";
