...
// recuperamos los nombres de los usuarios
    ...
    $cadena_personal = implode(", ", $nombresUsuarios);
    $rowdetalle['personal'] = regresaNombre($rowdetalle['id_persona_encargada'])  .' (' .totalOperativos($rowdetalle['id_persona_encargada'], $fechainicio,$fechafin) . ") ". ' *, ' . $cadena_personal;
