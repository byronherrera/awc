QoDesk.BodegaWindow = Ext.extend(Ext.app.Module, {
    ...
    createWindow: function () {
        ...
        var urlBodega = "modules/desktop/bodega/server/";
        ...
        // inicio ventana bodega
        var proxyBodega = new Ext.data.HttpProxy({
            api: {
                create: urlBodega + "crudBodega.php?operation=insert",
                read: urlBodega + "crudBodega.php?operation=select",
                update: urlBodega + "crudBodega.php?operation=update",
                destroy: urlBodega + "crudBodega.php?operation=delete"
            }
        });
