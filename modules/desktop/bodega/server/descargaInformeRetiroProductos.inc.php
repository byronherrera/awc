...
$objPHPExcel->getActiveSheet()->mergeCells('A' . $filaTitulo3 . ':W' . $filaTitulo3);

$objPHPExcel->getActiveSheet()->setCellValue('A' . $filaTitulo1, "INFORME DE RETIRO DE PRODUCTOS Y/O BIENES");
$objPHPExcel->getActiveSheet()->setCellValue('A' . $filaTitulo2, 'POR CONTROL DE USO INADECUADO DE ESPACIO PÚBLICO');
$objPHPExcel->getActiveSheet()->setCellValue('A' . $filaTitulo3, '1) DEL RETIRO');
...
$objPHPExcel->getActiveSheet()->setCellValue('S' . $filacabecera, 'Fecha de sorteo');
...
// actualizar detalle idGuia
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('S' . $filaInicio, $rowdetalle['fecha_sorteo']);
